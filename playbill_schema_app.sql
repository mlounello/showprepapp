SET search_path TO app_showprep, public;

--
-- PostgreSQL database dump
--

\restrict 5eARdFIUUvGEhYo9fflqvatmzDNhlnMk3U7xnhN4pdIDu1ug3SNbKg5Kvb9NYXi
...
CREATE TABLE app_showprep."Case" (
    id text NOT NULL,
...
CREATE TABLE app_showprep."CrewMember" (
    id text NOT NULL,
    name text NOT NULL
);
...
CREATE TABLE app_showprep."Issue" (
    id text NOT NULL,
...
CREATE TABLE app_showprep."Show" (
    id text NOT NULL,
    name text NOT NULL,
    dates text NOT NULL,
    venue text NOT NULL,
...
CREATE TABLE app_showprep."ShowCase" (
    id text NOT NULL,
    "showId" text NOT NULL,
    "caseId" text NOT NULL,
    "ownerId" text,
...
CREATE TABLE app_showprep."ShowTruck" (
    id text NOT NULL,
    "showId" text NOT NULL,
...
CREATE TABLE app_showprep."StatusEvent" (
    id text NOT NULL,
    "caseId" text NOT NULL,
    "showId" text,
...
CREATE TABLE app_showprep."TruckProfile" (
    id text NOT NULL,
    name text NOT NULL,
    "lengthIn" double precision,
    "widthIn" double precision,
...
ALTER TABLE ONLY app_showprep."Case"
...
ALTER TABLE ONLY app_showprep."CrewMember"
...
ALTER TABLE ONLY app_showprep."Issue"
...
ALTER TABLE ONLY app_showprep."ShowCase"
...
ALTER TABLE ONLY app_showprep."ShowTruck"
...
ALTER TABLE ONLY app_showprep."Show"
...
ALTER TABLE ONLY app_showprep."StatusEvent"
...
ALTER TABLE ONLY app_showprep."TruckProfile"
...
CREATE UNIQUE INDEX "ShowCase_showId_caseId_key" ON app_showprep."ShowCase" USING btree ("showId", "caseId");
...
CREATE UNIQUE INDEX "ShowTruck_showId_truckId_key" ON app_showprep."ShowTruck" USING btree ("showId", "truckId");
...
CREATE UNIQUE INDEX "TruckProfile_name_key" ON app_showprep."TruckProfile" USING btree (name);
...
ALTER TABLE ONLY app_showprep."Issue"
    ADD CONSTRAINT "Issue_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES app_showprep."Case"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY app_showprep."Issue"
    ADD CONSTRAINT "Issue_showId_fkey" FOREIGN KEY ("showId") REFERENCES app_showprep."Show"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY app_showprep."ShowCase"
    ADD CONSTRAINT "ShowCase_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES app_showprep."Case"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY app_showprep."ShowCase"
    ADD CONSTRAINT "ShowCase_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES app_showprep."CrewMember"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY app_showprep."ShowCase"
    ADD CONSTRAINT "ShowCase_showId_fkey" FOREIGN KEY ("showId") REFERENCES app_showprep."Show"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY app_showprep."ShowTruck"
    ADD CONSTRAINT "ShowTruck_showId_fkey" FOREIGN KEY ("showId") REFERENCES app_showprep."Show"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY app_showprep."ShowTruck"
    ADD CONSTRAINT "ShowTruck_truckId_fkey" FOREIGN KEY ("truckId") REFERENCES app_showprep."TruckProfile"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY app_showprep."StatusEvent"
    ADD CONSTRAINT "StatusEvent_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES app_showprep."Case"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY app_showprep."StatusEvent"
    ADD CONSTRAINT "StatusEvent_showId_fkey" FOREIGN KEY ("showId") REFERENCES app_showprep."Show"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
\unrestrict 5eARdFIUUvGEhYo9fflqvatmzDNhlnMk3U7xnhN4pdIDu1ug3SNbKg5Kvb9NYXi
